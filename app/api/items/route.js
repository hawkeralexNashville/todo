...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from('items')
    .select('id, name, description, type, status, position, prioritized, locked, bucket_id, completed_at, created_at, skipped_at, time_estimate, time_spent, timer_started_at')
